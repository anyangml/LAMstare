...
#             all_records = fetch_dptest_res(run_id)
#             all_records = parse_record_dict(all_records)
#             ax[0].loglog(all_records[""]["step"], all_records[""]["ener_rmse"],color=COLOR[idx],marker="o")
#             ax[0].set_ylabel(f"Energy")

#             ax[1].loglog(all_records[""]["step"], all_records[""]["force_rmse"],color=COLOR[idx],marker="o")
#             ax[1].set_ylabel(f"Force")

#             ax[2].loglog(all_records[""]["step"], all_records[""]["virial_rmse"],color=COLOR[idx],marker="o")
#             ax[2].set_ylabel(f"Virial")
...
#             for i, head in enumerate(heads_to_plot):
#                 if head in all_records:
#                     ax[i][0].loglog(all_records[head]["step"], all_records[head]["ener_rmse"],color=COLOR[idx],marker="o")
#                     ax[i][0].set_ylabel(f"Energy_{head}")

#                     ax[i][1].loglog(all_records[head]["step"], all_records[head]["force_rmse"],color=COLOR[idx],marker="o")
#                     ax[i][1].set_ylabel(f"Force_{head}")

#                     ax[i][2].loglog(all_records[head]["step"], all_records[head]["virial_rmse"],color=COLOR[idx],marker="o")
#                     ax[i][2].set_ylabel(f"Virial_{head}")
...
#     fig.legend(handles=legend_elements, loc='upper center', ncol=2, frameon=False)
#     fig.savefig("compare-test.jpg")
#     sendimg(["compare-test.jpg"], f"{exp_name}_dptest_RMSE")
